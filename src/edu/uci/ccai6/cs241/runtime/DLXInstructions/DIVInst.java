...
public class DIVInst extends DLXInstruction {
	public DIVInst(Instruction instruction) {
		int op = DLX.DIV, arg1 = 0, arg2 = 0, arg3 = 0;
		...
		if (argI3 instanceof SpilledRegisterArg) {
			...
			wrong("DIVInst: target can only be register");
		} else {
