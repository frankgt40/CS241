...
public class MULInst  extends DLXInstruction{
	public MULInst(Instruction instruction) {
		int op = DLX.MUL, arg1 = 0, arg2 = 0, arg3 = 0;
		Arg argI1 = instruction.arg0;
		Arg argI2 = instruction.arg1;
		Arg argI3 = instruction.arg2;
		
		if (!(argI3 instanceof RegisterArg)) {
			wrong("MulInst: target can only be register");
		} else {
