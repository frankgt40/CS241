...
public class StackAbstract {
	...
	private static Map<String, String> __fakeRegToMem = new HashMap<String, String>(); // <fake register name --> memory address in frames>
	...
	public Map<String, String> getRegToMem() {
		return __fakeRegToMem;
	}
	public FrameAbstract getCurrFrame() {
		return __stackAbstract.get(__currFrame);
	}
	public String getMemInFrame(String fakeReg) {
		// Needed to be done
